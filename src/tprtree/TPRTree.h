...
namespace SpatialIndex
{
	namespace TPRTree
	{
		...
		private:
			...
			void insertData_impl(size_t dataLength, byte* pData, MovingRegion& mbr, id_type id);
			void insertData_impl(size_t dataLength, byte* pData, MovingRegion& mbr, id_type id, size_t level, byte* overflowTable);
