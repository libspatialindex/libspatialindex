...
Tools::Geometry::LineSegment::LineSegment(const double* pStartPoint, const double* pEndPoint, size_t dimension)
...
//
size_t Tools::Geometry::LineSegment::getByteArraySize()
{
...
void Tools::Geometry::LineSegment::storeToByteArray(byte** data, size_t& len)
{
...
size_t Tools::Geometry::LineSegment::getDimension() const
{
	return m_dimension;
}
...
void Tools::Geometry::LineSegment::makeInfinite(size_t dimension)
{
	makeDimension(dimension);
...
void Tools::Geometry::LineSegment::makeDimension(size_t dimension)
{
