...
Tools::Geometry::Region::Region(const double* pLow, const double* pHigh, size_t dimension)
{
...
void Tools::Geometry::Region::initialize(const double* pLow, const double* pHigh, size_t dimension)
{
	m_pLow = 0;
...
//
size_t Tools::Geometry::Region::getByteArraySize()
{
...
void Tools::Geometry::Region::storeToByteArray(byte** data, size_t& len)
{
...
size_t Tools::Geometry::Region::getDimension() const
{
	return m_dimension;
}
...
double Tools::Geometry::Region::getLow(size_t index) const
{
...
double Tools::Geometry::Region::getHigh(size_t index) const
{
	if (index < 0 || index >= m_dimension)
		throw IndexOutOfBoundsException(index);
...
void Tools::Geometry::Region::makeInfinite(size_t dimension)
{
	makeDimension(dimension);
...
void Tools::Geometry::Region::makeDimension(size_t dimension)
{
